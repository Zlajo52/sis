...
- mnogi napadači koriste obfuskaciju ili kriptiranje kako bi izbjegli otkrivanje(mogu ga sakriti u datoteci, poput MS Word ili PDF datoteke)
- **Exploit kit** je automatizirana platforma koja sadrži različite exploite za razne ranjivosti. Te platforme olakšavaju napadačima pakiranje exploit koda unutar payloada, poput izvršne datoteke ili određenih dokumenata
